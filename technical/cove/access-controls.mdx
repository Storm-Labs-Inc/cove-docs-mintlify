...
controls `DEFAULT_ADMIN_ROLE` and `_TIMELOCK_ROLE`. Other roles will be
...
| Role              | Description                            | Privileges                                                                        | Controlled By |
| ----------------- | -------------------------------------- | --------------------------------------------------------------------------------- | ------------- |
| `_BASKET_MANAGER` | Address of the BasketManager contract. | `fulfillDeposit`, `fulfillRedeem`, `fallbackRedeemTrigger`, `prepareForRebalance` | N/A           |
...
| Role                 | Description                                     | Privileges                                             | Controlled By |
| -------------------- | ----------------------------------------------- | ------------------------------------------------------ | ------------- |
| `DEFAULT_ADMIN_ROLE` | Admin role with full control over the contract. | `setProtocolTreasury`, `setSponsor`, `setSponsorSplit` | N/A           |
| `_BASKET_TOKEN_ROLE` | Role for basket tokens to notify fees.          | `notifyHarvestFee`                                     | N/A           |
...
| Role                    | Description                               | Privileges                                      | Controlled By        |
| ----------------------- | ----------------------------------------- | ----------------------------------------------- | -------------------- |
| `DEFAULT_ADMIN_ROLE`    | Admin role for managing the contract.     | Can assign/revoke roles and manage strategies.  | N/A                  |
...
| Role                 | Description                                     | Privileges         | Controlled By        |
| -------------------- | ----------------------------------------------- | ------------------ | -------------------- |
| `DEFAULT_ADMIN_ROLE` | Admin role with full control over the contract. |                    | N/A                  |
| `_MANAGER_ROLE`      | Role for managing target weights.               | `setTargetWeights` | `DEFAULT_ADMIN_ROLE` |
