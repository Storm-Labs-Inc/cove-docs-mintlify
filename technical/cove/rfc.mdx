...
Pricing the tokens of each Basket in terms of USDT is challenging because:
...
This dynamic nature of a Basket's composition makes it difficult to determine a straightforward USDT price for its tokens at any given point in time.
...
$$ feeOnSell = sellAmount \times \frac{swapFeeBps}{1e4} $$
$$ feeOnBuy = buyAmount \times \frac{swapFeeBps}{1e4} $$
